...
if (reset) {
  await Promise.all([Material.deleteMany({}), Product.deleteMany({}), Day.deleteMany({}), Order.deleteMany({}), Settings.deleteMany({}), Counter.deleteMany({}), Target.deleteMany({}), Movement.deleteMany({})]);
