...
//   npm run user -- aziz Parol123 pto "Aziz Karimov"  — rol: admin | pto | usta | omborchi | rahbar | kurator
import mongoose from "mongoose";
import { connectDB } from "../src/db.js";
import { User } from "../src/models.js";
import { clearUserLocks } from "../src/limits.js";
...
if (!username || !password) {
  console.log('Foydalanish: npm run user -- <login> <parol> [admin|pto|usta|omborchi|rahbar|kurator] ["Ism Familiya"]');
  process.exit(1);
}
...
if (existing) {
  ...
  await existing.save();
  await clearUserLocks(login); // barcha qurilmalardagi kirish bloklari olib tashlanadi
